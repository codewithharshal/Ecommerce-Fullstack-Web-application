    ...
    <div>
      ...
      <div>
        {orders.map((orders, index) => (
          <div
            className="grid grid-cols-1 sm:grid-cols-[0.5fr_2fr_1fr] lg:grid-cols-[0.5fr_2fr_1fr_1fr_1fr] gap-3 items-start border-2 border-gray-200 p-5 md:p-8 py-3 md:py-4 text-xs sm:text-sm text-gray-700"
            key={index}
          >
            ...
            <div>
              ...
              <p className="mt-3">PaymentMethod: {orders.paymentMethod}</p>
            ...
            <select
              onChange={(e) => statusHandler(e, orders._id)}
              value={orders.status}
