...
const AddProduct = ({ token }) => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      formatData.append("subCategory", subCategory);
      formatData.append("bestseller", bestSeller);
      formatData.append("sizes", JSON.stringify(sizes));
      ...
      image5 && formatData.append("image5", image5);
